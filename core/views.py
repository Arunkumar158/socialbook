...
def search(request):
    ...
    if request.method == 'POST':
        ...
        for users in username_object:
            ...
            username_profile_list.append( username_profile_list)

            username_profile_list = list(chain(*username_profile_list))
        return render(request, 'search.html', {'user_profile': user_profile, 'username_profile_list':username})
...
def like_post(request):
    ...
    post_id = request.GET.get(id='post_id')
...
def profile (request,pk):
    ...
    user_profile = Profile.objects.get(user_object)
